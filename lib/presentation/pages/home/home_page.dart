...
import 'package:mocks/models/beach_model.dart';
...
import 'package:mocks/presentation/widgets/bottom_navigation_bar_travel.dart';
          ...
          Container(
            ...
            child: DefaultTabController(
              ...
              child: TabBar(
                ...
                indicatorPadding: const EdgeInsets.symmetric(horizontal: 14.4),
                isScrollable: true,
            ...
            child: PageView(
              ...
              children: List.generate(
                ...
                (int index) => GestureDetector(
                  ...
                  child: Hero(
                    tag: recommendations[index].image,
                    child: Container(
